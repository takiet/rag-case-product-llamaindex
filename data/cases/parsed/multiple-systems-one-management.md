...
* [English](/customer-story/multiple-systems-one-management)
...
* North and Central America
  ...
  + United States
     -
    [English](/en-us)
  Can't find your location? Visit our [global site in English](/customer-story/multiple-systems-one-management).
* South America
...
![NURA Health Screening Center](/sites/axis/files/styles/3_2_800_x_533/public/2024-12/16_0.jpg.webp?h=84ce2e78&itok=rRdnnJ4R)

Healthcare

# Multiple systems, one management platform: A solution for workforce efficiency

Organization:
NURA Health Screening Center
...
Multiple systems managed under one platform helps to simplify tasks for a more efficient workforce

---

![The power of single management](/sites/axis/files/styles/4_3_800_x_600/public/2024-12/23.jpg.webp?h=84ce2e78&itok=wyMmiIoV)

## The power of single management

When the Tavan Bogd Group planned the NURA Health Screening Center in Ulaanbaatar, Mongolia, company officials knew the new screening center  needed a security system that could handle multiple functions.

“We wanted something that was simple but reliable, and easy to train new workers to use,” says Enkhbold.T, the IT engineer for NURA Mongolia. “Worker shortage is one of the greatest challenges facing the healthcare industry today, so a system that can be managed by one person is ideal.”

Tavan Bogd Group worked with Axis on choosing a fully integrated solution that combines CCTV, access control, and audio into one easy to use management platform that uses Axis Camera Station. It is the first end-to-end project with recorder, access control, and network audio in Mongolia.

“By using the Axis system, we were able to solve the lack of workforce problem in the most efficient way. It’s easy to use and easy to train new employees on operating the system,” Enkhbold.T adds.

![Supporting healthcare built on innovation](/sites/axis/files/styles/4_3_800_x_600/public/2024-12/18_R1.jpg.webp?h=463ff0b9&itok=eQ0j0qPe)

## Supporting healthcare built on innovation

The NURA Health Screening Center, a partnership with Fujifilm, focuses on cancer and lifestyle disease screening. The new, high-end screening center integrates Fujifilm’s medical devices with artificial intelligence (AI) to support doctors in early detection of diseases. Customers  at NURA health screening centers expect high-quality medical care with fast results.

“Customers  trust this hospital because it uses state-of-the-art technology that reduces wait time and supports both patients and doctors. That attention to quality and innovation is important to us, and extends to everything we do – including security,” says NURA Mongolia Operations Manager Delgerjargal.Ts. “The Axis system supports the mission of NURA by helping to streamline management processes in an environment where time and efficiency is essential to a positive customer outcome.”

For example, the AXIS dome camera, installed in the waiting room, helps to monitor and control crowds. The camera’s smart edge analytics can detect when a preprogrammed occupancy threshold is reached.

“CCTV cameras are used for monitoring all public areas, and with Axis Object Analytics, we know the live occupancy of the waiting area.” Enkhbold.T adds.

Data from the analytics is a valuable tool for management to review and optimize different areas of the screening center.

![Network audio soothes and reassures](/sites/axis/files/styles/4_3_800_x_600/public/2024-12/10_R1.jpg.webp?h=463ff0b9&itok=6B5GWlFP)

## Network audio soothes and reassures

The Axis system also supports a calming atmosphere for customers waiting on important tests.

AXIS network speakers play background music, and convey important message announcements. The speakers are also effective in CT scanning rooms and in reception, where workers can communicate with the patient through the 2N SIP MIC through a single press of a button.

“The system runs very smoothly,” Delgerjargal.Ts says. “Each element works seamlessly to support, protect, and inform employees and patients. The entire system was built in a quick timeline of just two months, from design to handover, and Axis was an excellent partner in meeting our needs.”

With the success of the first NURA Health Screening Center and its outstanding performance, the Tavan Bogd Group is continuing to deploy Axis Solutions for the launch of the new flagship center, "MEGA NURA," in Mongolia.

## Products & solutions

![AXIS M4225-LVE](/sites/axis/files/styles/square_130x130_/public/2025-05/m4225_m4228_wall_angle_left_2401_Productimageswithcropping.png?itok=3wELSioD)

#### AXIS M42 Dome Camera Series

Affordable AI-powered varifocal domes

[Learn more](/products/axis-m42-series)

![Combo c1210 c1211 grey](/sites/axis/files/styles/square_130x130_/public/2022-07/combo_c1210_c1211_wall_angle_left_2600x1950_2207_1.png?itok=AikkPpTN)

#### AXIS C12 Network Ceiling Speaker Series

Discreet ceiling installation

[Learn more](/products/axis-c12-series)

![AXIS C1111-E, viewed from its left angle](/sites/axis/files/styles/square_130x130_/public/2024-01/c1111e_white_horizontal_angle_left_2310-Productimageswithcropping.png?itok=3k7GPgpt)

#### Network audio

Audio made smart and easy

[Learn more](/products/network-audio)

![A610](/sites/axis/files/styles/square_130x130_/public/2023-10/a1610_front_2212.png?itok=iZ2xbn60)

#### AXIS A16 Network Door Controller Series

Versatile edge-based two-door controllers

[Learn more](/products/axis-a16-series)

![AXIS S12](/sites/axis/files/styles/square_130x130_/public/2022-09/axis_s1232_s1264_s1296_packshoot_2204_0.png?itok=Hg4o1bgl)

#### AXIS Camera Station S12 Recording Server Series

[Learn more](/products/axis-s12-series)

![wheels in different sizes in a yellow color on a yellow background](/sites/axis/files/styles/square_160x160_/public/2020-11/top_banner_end_to_end_3840x1536_2011.jpg?itok=GNLvy4-3)

#### End-to-end solutions

You can rest easy with a system tailored to your needs, using perfectly matched components, all from Axis. Right for you today. And tomorrow.

[Learn more](/solutions/end-to-end-solutions)

## Our partner organizations

#### Tavan Bogd Nura LLC

[Visit website](https://tavanbogd.com/)
